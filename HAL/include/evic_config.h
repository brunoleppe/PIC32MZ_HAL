...
**********************************************************************/
/**
 * @brief Define el canal de la interrupci�n.
 *  
 */
typedef uint32_t EVIC_IrqChannel;
/**
 * @brief Define las posibles prioridades de la interrupci�n.
 * 
 */
typedef enum{
    IRQ_PRIO_0 = 0,
...
/**
 * @brief Define las posibles subprioridades de la interrupci�n.
 * 
 */
typedef enum{
    IRQ_SUB_0 = 0,
...
/**
 * @brief Define el estado de la interrupci�n.
 * 
 */
typedef enum{
    IRQ_ENABLED,
