 ...
 * @param txBuffer B�ffer de transmisi�n de datos.
 * @param rxBuffer B�ffer de recepci�n de datos.
...
/**
 * @brief Configura el canal SPI con los par�metros proporionados
 * 
 * @param channel Canal SPI.
 * @param setup Estructura de par�metros para la configuraci�n del canal.
 * 
...
/**
 * @brief Escribe en un registro del perif�rico SPI.
 * 
 * @param address Direcci�n de memoria del registro.
 * @param value Valor que ser� escrito en el registro.
 */
void SPI_RegisterWrite(uint32_t address, uint32_t value);
/**
 * @brief Lee el contenido de un registro del perif�rico  SPI.
 * 
 * @param address Direcci�n de memoria del registro.
